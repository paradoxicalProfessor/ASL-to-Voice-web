"""
ASL to Voice - Optimized Gradio Interface for Hugging Face Spaces
Fast ASL detection with snapshot mode (non-streaming for better performance)
"""
